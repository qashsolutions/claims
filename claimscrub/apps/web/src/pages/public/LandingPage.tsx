        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="bg-white rounded-2xl border-2 border-rose-200 p-6 shadow-sm w-full h-48">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="bg-white rounded-2xl border-2 border-amber-200 p-6 shadow-sm w-full h-48">
                <div className="flex items-center gap-2 mb-4">
                ...
                <p className="text-sm text-neutral-700 mb-2">Add diagnosis code:</p>
                <div className="bg-neutral-50 rounded-lg p-3">
                  <div className="flex items-center justify-between">
                    ...
                    <button className="px-3 py-1.5 bg-amber-600 text-white text-xs font-semibold rounded-lg">
                      Apply
                    </button>
                  </div>
                </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="bg-white rounded-2xl border-2 border-green-200 p-6 shadow-sm w-full h-48">
                <div className="flex items-center gap-2 mb-4">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="bg-white rounded-2xl border-2 border-blue-200 p-6 shadow-sm w-full h-48">
                <div className="flex items-center gap-2 mb-4">
                ...
                <p className="text-sm text-neutral-700 mb-2">If denied, we help you appeal:</p>
