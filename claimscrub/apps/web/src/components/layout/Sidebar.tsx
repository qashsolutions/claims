  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 top-20 flex h-6 w-6 items-center justify-center rounded-full border border-neutral-200 bg-white shadow-sm hover:bg-neutral-50"
      >
        <svg
          className={cn('h-4 w-4 text-neutral-600 transition-transform', !sidebarOpen && 'rotate-180')}
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
